...
namespace NaughtyAttributes
{
    ...
    public class ShowIfAttribute : ShowIfAttributeBase
    {
        ...
        public ShowIfAttribute(EConditionOperator conditionOperator, string enumName, params object[] conditions)
            : base(conditionOperator, enumName, Array.ConvertAll(conditions, item => (Enum)item))
        {
            Inverted = false;
        }
    }
